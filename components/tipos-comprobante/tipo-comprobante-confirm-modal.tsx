...
const MODAL_ID = "tipo-comprobante-confirm-modal";

interface TipoComprobanteConfirmModalProps {
  abierto: boolean;
  titulo: string;
  mensaje: ReactNode;
...
export function TipoComprobanteConfirmModal({
  abierto,
  titulo,
  mensaje,
  textoConfirmar,
  ...
  onConfirmar,
  onCerrar,
}: TipoComprobanteConfirmModalProps) {
  useEffect(() => {
    if (abierto) {
